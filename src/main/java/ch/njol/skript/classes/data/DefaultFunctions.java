...
public class DefaultFunctions {
	...
	static {
		...
		Functions.registerFunction(new SimpleJavaFunction<Number>("round", new Parameter[]{new Parameter<Number>("n", DefaultClasses.NUMBER, true, null), new Parameter<Number>("d", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, false))}, DefaultClasses.NUMBER, true) {
			@Override
		...
		Functions.registerFunction(new SimpleJavaFunction<Number>("log", new Parameter[]{new Parameter<Number>("n", DefaultClasses.NUMBER, true, null), new Parameter<Number>("base", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(10, false))}, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<Number>("atan2", new Parameter[]{
			new Parameter<Number>("x", DefaultClasses.NUMBER, true, null),
			new Parameter<Number>("y", DefaultClasses.NUMBER, true, null)
		...
		Functions.registerFunction(new SimpleJavaFunction<Number>("clamp", new Parameter[]{
				new Parameter<Number>("values", DefaultClasses.NUMBER, false, null),
				new Parameter<Number>("min", DefaultClasses.NUMBER, true, null),
				new Parameter<Number>("max", DefaultClasses.NUMBER, true, null)
		...
		Functions.registerFunction(new SimpleJavaFunction<Date>("date", new Parameter[]{
			new Parameter<Number>("year", DefaultClasses.NUMBER, true, null),
			new Parameter<Number>("month", DefaultClasses.NUMBER, true, null),
			new Parameter<Number>("day", DefaultClasses.NUMBER, true, null),
			new Parameter<Number>("hour", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, true)),
			new Parameter<Number>("minute", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, true)),
			new Parameter<Number>("second", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, true)),
			new Parameter<Number>("millisecond", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, true)),
			new Parameter<Number>("zone_offset", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(Double.NaN, true)),
			new Parameter<Number>("dst_offset", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(Double.NaN, true))
		...
		Functions.registerFunction(new SimpleJavaFunction<Long>("calcExperience", new Parameter[]{
			new Parameter<Long>("level", DefaultClasses.LONG, true, null)
		...
		Functions.registerFunction(new SimpleJavaFunction<ch.njol.skript.util.Color>("rgb", new Parameter[]{
				new Parameter<Long>("red", DefaultClasses.LONG, true, null),
				new Parameter<Long>("green", DefaultClasses.LONG, true, null),
				new Parameter<Long>("blue", DefaultClasses.LONG, true, null)
